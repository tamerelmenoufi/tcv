        ...
        <div class="row">
            <div class="col">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="training_description" style="background-color:#fff; height:40px; width:100%; margin-top:5px; opacity:1; color:a1a1a1; border:solid 1px red;"><?=$Dic['Training Description']?>*</label>
                </div>
