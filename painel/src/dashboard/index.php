            ...
            <tr>
                <td>
                    ...
                    <div style="height:25px; border-radius:5px; background-color:#eee; width:100%">
                        <div style="height:25px; padding:5px; border-radius:5px; margin-bottom:10px; background-color:green; width:<?=number_format($d->qt*100/$d->total,0,false,false)?>%; text-align:center; color:#fff; font-size:12px;"><?=number_format($d->qt*100/$d->total,0,false,false)?>%</div>
                    </div>
                </td>
            </tr>
            <?php
